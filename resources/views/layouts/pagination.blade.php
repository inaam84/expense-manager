...
@if ($collection->hasPages())
    <nav aria-label="Page navigation">
        <ul class="pagination pagination-sm justify-content-center">
            ...
            @else
                <li class="page-item">
                    <a class="page-link" href="{{ $collection->previousPageUrl() }}" rel="prev" aria-label="@lang('pagination.previous')">&lsaquo;</a>
                </li>
            @endif
            ...
            @if ($collection->hasMorePages())
                <li class="page-item">
                    <a class="page-link" href="{{ $collection->nextPageUrl() }}" rel="next" aria-label="@lang('pagination.next')">&rsaquo;</a>
                </li>
            @else
